...
required_packages <- c("rmarkdown", "gprofiler2", "data.table", "ggplot2", "igraph", "reticulate", "plotly", "tidyr", "dplyr", "GGally", "ComplexHeatmap", "circlize", "readxl", "ggpattern", "stringr", "openxlsx")
...
# TODO: generate logging supplementary figure -> either source the file or create function (but code already clean)
source("logging.R")
...
sankey <- generate_sankey_plot(data_info)

# Number of extracted DAPs per study and tissue type
boxplot_DAPs <- plot_boxplot_DAPS(intersections_all)

# Number of CAPs per study and tissue type (pre-filtered and post-filtered)
barplot_CAPs <- plot_barplot_CAPS(intersections_all, filtered_intersections)
...
```{r}
plot_original_vs_harmonized_intersections(intersections, filtered_intersections, intersections_original) # TODO: bug fixing -> figure not the same as previously
...
```{r}
# TODO: change to eps
png(paste0(out_dir, "scoring/scoring_heatmap.png"), width=11,height=12,units="in",res=1200)
