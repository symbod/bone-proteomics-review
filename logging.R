...
plot_harmonization_impact <- function(filter_ID_overview_dt, filter_IDs_detailed, )
ordered_studies <- c("1_Human", "2_Human", "3_Human", "4_Human", "5_Human", "6_Human", "7_Human", "8_Human", "9_Human", "10_Human", "11_Human", "12_Human",
                     ...
                     "27_Human", "28_Rat", "29_Rat","30_Rat" ,"31_Rabbit")

# ==== Filter IDs =====
# Load the data from the first file
data <- read.csv("data/harmonization/logging/filter_ids_overview.csv")
data$X <- NULL
...
data_detailed <- read.csv("data/harmonization/logging/filter_ids_detailed.csv")
...
remap_data <- read.csv("data/harmonization/logging/remap_genenames_overview.csv")
remap_data$X <- NULL
...
# ==== Reduction Symbols =====
reduced_data <- read.csv("data/harmonization/logging/reduce_genenames_overview.csv")
reduced_data$X <- NULL
...
# ==== Ortholog Symbols =====
ortholog_data <- read.csv("data/harmonization/logging/map_orthologs_overview.csv")
...
not_human_studies <- c("25_Mouse", "26_Mouse", "27_Mouse","28_Rat", "29_Rat","30_Rat","31_Rabbit")
...
ggarrange(p1, p2, p3, labels = c("A", "B", "C"), ncol = 1)
ggsave(paste0(harm_out_dir, "_proharmed_logging.png"), width = 8, height = 12)
