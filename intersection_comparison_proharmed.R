...
########## Visualize Utility of ProHarMeD ##########
...
# Basic piechart
tmp$Species <- factor(tmp$Species, levels = c("Human", "Rat", "Mouse", "Rabbit"))
...
ggsave("/Users/lisiarend/Desktop/pie_plots_studies.png", width = 12, height = 4.5)
